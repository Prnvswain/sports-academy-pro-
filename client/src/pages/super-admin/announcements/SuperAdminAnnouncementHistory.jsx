...
import { superAdminGet, superAdminDelete, superAdminPatch } from '../../../api/client';
...
export default function SuperAdminAnnouncementHistory() {
  ...
  const fetchAnnouncements = async () => {
    ...
    try {
      ...
      const response = await superAdminGet(`/super-admin/announcements?${params}`);
  ...
  const handleDelete = async (announcementId) => {
    ...
    try {
      await superAdminDelete(`/super-admin/announcements/${announcementId}`);
  ...
  const handleArchive = async (announcementId) => {
    try {
      await superAdminPatch(`/super-admin/announcements/${announcementId}/archive`);
      fetchAnnouncements();
    } catch (error) {
  ...
  const handleViewStats = async (announcementId) => {
    navigate(`/super-admin/announcements/${announcementId}/stats`);
  };

  const handleViewDetails = (announcementId) => {
    navigate(`/super-admin/announcements/${announcementId}`);
  };
      ...
      >
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage announcements across all academies</p>
          </div>
          <button
            onClick={() => navigate('/super-admin/announcements/create')}
