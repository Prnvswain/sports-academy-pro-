  ...
  return (
    <div className="w-full bg-transparent font-sans p-2 space-y-6 text-left">
      ...
      <motion.div 
        ...
        className="bg-card border border-border rounded-2xl p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-sm"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-black text-foreground tracking-tight">Overview Dashboard</h2>
