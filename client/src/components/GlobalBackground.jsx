export default function GlobalBackground() {
  return (
    <div className="absolute inset-0 -z-10 bg-slate-50 dark:bg-slate-950 select-none pointer-events-none overflow-visible">
      {/* Yellow top 30% (30vh height) - using theme background gradient */}
      <div className="w-full h-[30dvh] relative overflow-visible" style={{ backgroundColor: 'var(--theme-background-gradient, #FFC400)' }}>
        {/* Curve transition to the background color */}
        <div className="absolute bottom-0 left-0 right-0 translate-y-[99%] overflow-visible" style={{ color: 'var(--theme-background-gradient, #FFC400)' }}>
