...
export const listEvents = async (req, res) => {
  try {
    ...
    const events = await calendarService.getCalendarEvents(academyId, req.query);
...
export const createEvent = async (req, res) => {
  try {
    const academyId = req.user.academy_id;
    const event = await calendarService.createCalendarEvent(academyId, req.body);
...
export const updateEvent = async (req, res) => {
  try {
    ...
    const event = await calendarService.updateCalendarEvent(academyId, eventId, req.body);
...
export const deleteEvent = async (req, res) => {
  try {
    const academyId = req.user.academy_id;
    const eventId = req.params.event_id;
    await calendarService.deleteCalendarEvent(academyId, eventId);
...
export const getDashboardStats = async (req, res) => {
  try {
    const academyId = req.user.academy_id;
    const stats = await calendarService.getCalendarDashboardStats(academyId);
